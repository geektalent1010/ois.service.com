...
<div class="container-section solution-section body-solution">
            ...
            <div class="d-flex">
                <div class="w-50">
                    <p class="intro-content content-first">At OIS, we understand that identity verification and data
                        ...
                        Electronic Payment Transfers, BVN, and E-health services. However, the current systems may be
                        ...
                        frustration for our customers. Moreover, data breaches, hacking, and identity theft have become
            ...
            <div class="less-section-first d-none">
                <div class="w-50">
                    ...
                    <p class="intro-content content-first">Inaccurate or insecure identity verification can have serious
                        ...
                        verification can lead to medical errors, jeopardize patient safety, and negatively impact public
                        health outcomes. Additionally, inaccurate data management can compromise national security, this
    ...
    <div class="mobile-version">
        ...
        <div class="content-section">
            ...
            <p class="intro-content content-first">At OIS, we understand that identity verification and data management
                are critical components of our services, including Visa and Passport processing, Electronic Payment
                Transfers, BVN, and E-health services. However, the current systems may be prone to errors, fraud, and
                ...
                breaches, hacking, and identity theft have become increasingly common, posing a significant risk to data
            ...
            <div class="less-section-first d-none">
                <p class="intro-content content-first">Inaccurate or insecure identity verification can have serious
                    consequences, including financial losses, legal issues, and damage to reputation. Inaccurate
                    identity verification can lead to fraud, such as identity theft, which could be financially damaging
                    to our customers. In the context of E-health solutions, inaccurate identity verification can lead to
            ...
            <div class="d-flex">
                ...
                <div class="w-50">
                    ...
                    <p class="intro-content content-second mb-0">OIS is dedicated to revolutionizing global identity
                        ...
                        seamlessly verify their identities and access critical services in a trusted and decentralized
                        ecosystem.</p>
                </div>
            </div>
        </div>
        ...
        <div class="content-section less-section-second d-none pb-0">
            <div class="d-flex">
                ...
                <div class="w-50">
                    ...
                    <p class="intro-content content-second">We will use AI and machine learning to gain insights from
                        data and develop models that can improve efficiency, accuracy, and customer experience.
                        Blockchain will provide a secure and transparent record of transactions, while Web3 will enable
                    ...
                    <p class="intro-content content-second">OIS will leverage Blockchain and Web3 technologies to create
                        ...
                        decentralized finance (DeFi) ecosystem that is transparent, efficient, and accessible to all.
                        This ecosystem will enable our customers to transfer money seamlessly, with reduced transaction
                        fees, improved efficiency, and enhanced security.</p>
                    <p class="intro-content content-second strong-text"><strong>Leveraging Technology for Secure and
                            Decentralized E-health Solutions:</strong></p>
                    <p class="intro-content content-second">OIS will also leverage machine learning, blockchain, and
                        Web3 technologies to create secure and decentralized E-health solutions. These solutions will
                        enable patients to securely and easily access their medical records, receive remote
                        consultations, and connect with healthcare providers in a trusted and decentralized ecosystem.
                    </p>
    ...
    <div class="mobile-version">
        ...
        <div class="content-section">
            ...
            <p class="intro-content content-second strong-text"><strong>Revolutionizing Global Identity Verification and
                    Data Management:</strong></p>
            <p class="intro-content content-second mb-0">OIS is dedicated to revolutionizing global identity
                verification and data management by leveraging advanced technologies such as AI, machine learning,
                blockchain, and Web3. These technologies will enable us to provide secure, transparent, and efficient
                solutions that empower individuals and organizations to easily and seamlessly verify their identities
        ...
        <div class="content-section less-section-second d-none pb-0">
            <div>
                ...
                <p class="intro-content content-second strong-text"><strong>Technologies to be leveraged for Secure and
                        Decentralized Identity Verification Solutions:</strong></p>
            </div>
            <p class="intro-content content-second">We will use AI and machine learning to gain insights from data and
                develop models that can improve efficiency, accuracy, and customer experience. Blockchain will provide a
                secure and transparent record of transactions, while Web3 will enable the creation of decentralized
                solutions.</p>
            <p class="intro-content content-second strong-text"><strong>Leveraging Technology for Secure and
                    Decentralized Financial Services:</strong></p>
            <p class="intro-content content-second">OIS will leverage Blockchain and Web3 technologies to create secure
                ...
                enable our customers to transfer money seamlessly, with reduced transaction fees, improved efficiency,
                and enhanced security.</p>
            <p class="intro-content content-second strong-text"><strong>Leveraging Technology for Secure and
                    Decentralized E-health Solutions:</strong></p>
            <p class="intro-content content-second">OIS will also leverage machine learning, blockchain, and Web3
                technologies to create secure and decentralized E-health solutions. These solutions will enable patients
            ...
            <p class="intro-content content-second strong-text"><strong>Overall Benefits of Our New Solution:</strong>
            </p>
            <p class="intro-content content-second">By leveraging these technologies, OIS aims to provide secure,
                transparent, and efficient solutions that empower individuals and organizations to easily and seamlessly
                verify their identities and access critical services in a trusted and decentralized ecosystem. These
                solutions will reduce the risk of fraud and identity theft, improve efficiency and accuracy, and provide
