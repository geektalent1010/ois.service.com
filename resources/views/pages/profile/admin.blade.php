    ...
    <div class="main-bg">
        ...
        <div class="m-0 profile-section">
            ...
            <div class="section-body body-section mt-5 mb-5">
                ...
                <div class="profile-role-section mt-5">
                    <div class="profile-role-header">
                        {{__('MY ROLES')}}
                    </div>
                    <div class="profile-role-details mt-3">
                        <div class="profile-role-details-side">
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" checked />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('CHANGE MY PERSONAL DATA') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('SET ADMIN ROLES') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" checked />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('REVIEW CLIENT INFORMATION') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('START EMAIL CAMPAIGNS') }}</span>
                                </label>
                            </div>
                        </div>
                        <div class="profile-role-details-side">
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" checked />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('EDIT WEBSITE') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('EDIT OFFICES') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" checked />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('EDIT DOCUMENTS') }}</span>
                                </label>
                            </div>
                            <div class="profile-role-detail">
                                <label class="checkbox-container">
                                    <input type="checkbox" checked />
                                    <span class="checkbox-circle"></span>
                                    <span class="checkbox-name">{{ __('EDIT PRICING') }}</span>
                                </label>
                            </div>
                        </div>
                    </div>
