    ...
    <div class="main-bg">
        ...
        <div class="m-0 intro-section">
            <div class="title-section d-flex flex-column justify-content-center align-items-center">
                <p class="title desktop-version body-section">Helping businesses and individuals<br>overcome complex
                    challenges.</p>
            ...
            <div class="content-section aos-init body-section">
                ...
                <div class="block-section">
                    ...
                    <div class="text-section d-flex justify-content-center">
                        <div class="description-section">
                            <p class="sub-title">REVOLUTIONIZING ELECTRONIC MONEY TRANSFER WITH BLOCKCHAIN AND WEB3
                                TECHNOLOGIES</p>
