@extends('layouts.app', ['ACTIVE_TITLE' => 'BOOKING'])
...
<div class="container-section">  
    ...
    <div class="book-section">
        ...
        <p class="page-footer desktop-version">If you have not completed your visa application, Plesae <a href="https://portal.immigration.gov.ng/visa/freshVisa" class="visit" target="_blank">VISIT</a> to complete your application,<br>before returning to OIS to book your appointment</p>
        <p class="page-footer mobile-version">If you have not completed your visa application,<br>Plesae <a href="https://portal.immigration.gov.ng/visa/freshVisa" class="visit" target="_blank">VISIT</a> to complete your application,<br>before returning to OIS to book your appointment</p>
    </div>
</div>
@endsection
