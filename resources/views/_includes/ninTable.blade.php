    ...
    <div class="col-md-12 checklistsFilters" id="filter-content1">
        <div class="w-100">
            <div class="accordion" id="document">
                ...
                <div class="card" id="allCountryFeeInfo" style="display:none">
                ...
                <div class="card" id="africaFeeInfo" style="display:none">
                ...
                <div class="card" id="nigeriaFeeInfo" style="display:none">
                ...
                <div class="card" id="nigeriaVerifyFeeInfo" style="display:none">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=""><br></div>
                                                <div class="">
                                                    VERIFICATION SERVICE L2 - Picture, names (last, middle & first names)<br /><br />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="">₦ 100.00</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=""><br></div>
                                                <div class="">
                                                    VERIFICATION SERVICE L3 - Picture, signature, names (last, middle & first names), address.
                                                    <br /><br />
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=""><br></div>
                                                <div class="">
                                                    VERIFICATION SERVICE L4 - Picture, signature, names, (last, middle & first names), DOB, gender, address & phone number.
                                                    <br /><br />
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class=""><br></div>
                                                <div class="">
                                                    VERIFICATION SERVICE L5 - Picture, signature, names, (last, middle & first names) DOB, gender, NIN, phone number & all modifications carried out as at the date of verification
                                                    <br /><br />
                                                </div>
                                            </td>
                                            <td>
