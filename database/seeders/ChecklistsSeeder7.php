...
class ChecklistsSeeder7 extends Seeder
{
    ...
    public function run()
    {
        ...
        Checklist::create([
            ...
            A letter of invitation from the Ministry of foreign affairs. This must be addressed to the Nigerian embassy in Beirut, Lebanon.
            ',
        ...
        Checklist::create([
            ...
            	Processing Time:- Minimum of 10 working days. <br/>
            ...
            	All Documents and letters must be formal. They should be typed, printed in portrait, addressed to the Nigerian Embassy in Beirut, Lebanon, signed and dated.<br/>
            	Please not that once applications have been submitted or mailed to the embassy, visas and processing fees are not refundable; notwithstanding if visas are granted or not.<br/>
            	Please note that application processing fees are not refundable once submitted for processing.<br/>
            	Non-Lebanese passport holders must submit a copy of proof of legal residency (photocopy of green card, resident visa, work permit or necessary visa page).<br/><br/>
            
            
            Please check our opening hours to avoid delays and for any additional information please email us @infobeirut@oisservices.com            
            ',
